                        ...
                        <SwiperSlide key={i}>
                            <div className="grid grid-rows-2 md:grid-rows-1 md:grid-cols-2 xl:grid-cols-2">
                                <div className="grid grid-cols-5 md:grid-cols-6 xl:grid-cols-4">
                                    <div className="col-start-2 col-span-3 md:col-start-2 md:col-span-4 xl:col-start-2 xl:col-span-2 flex flex-col gap-6 text-center text-white mt-12 mb-8">
                                        <div className="text-sm md:text-base xl:text-left xl:text-lg font-semibold">{slide.category}</div>
                                        <div className="text-[26px] leading-8 xl:text-left xl:text-4xl xl:leading-10 font-black">{slide.text}</div>
